...
<div class="wrap  ">
    <?php
        NavBar::begin([
            'brandLabel' => Yii::$app->name = 'El Cuyo',
          ...
          if (Yii::$app->user->isGuest) {
              ...
              if ($es_admin = PermisosHelpers::requerirMinimoRol('Admin')) {
                  $menuItems[] = ['label' => 'Control de Acceso',
                            'items' => [
                                ['label' => 'Usuarios', 'url' => ['/user/index']],
                                ['label' => 'Perfiles', 'url' => ['/perfil/index']],
                                ['label' => 'Roles', 'url' => ['/rol/index']],
                                ['label' => 'Estados', 'url' => ['/estado/index']],
                                ['label' => 'Tipo de usuarios', 'url' => ['/tipo-usuario/index']],
                            ],
                            'options' => ['class' => 'dropdown'],
                  ];
              }

              $menuItems[] = ['label' => 'Restaurant', 'url' => ['/restaurant/index']];
              $menuItems[] = ['label' => 'Mi Perfil', 'url' => ['/perfil/index']];
              $menuItems[] = '<li>'
                  . Html::beginForm(['/site/logout'], 'post')
                  . Html::submitButton(
                      'Logout (' . Yii::$app->user->identity->username . ')',
                      ['class' => ' badge-dark logout']
                  )
                  . Html::endForm()
                  . '</li>';
          }//fin del eslse
